        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6" autocomplete="off">
          ...
          >
            <button
              ...
              className={`group relative w-40 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white ${
                isRunning ? 'bg-green-600' : isCheating ? 'bg-red-600' : 'bg-blue-600 hover:bg-blue-700'
